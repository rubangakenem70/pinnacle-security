...
const App = () => {
  return (
    <BrowserRouter>
      ...
      .table-wrap{overflow-x:auto;background:#fff;border-radius:8px;margin-top:10px}.admin-table{width:100%;border-collapse:collapse;font-size:11px}.admin-table th{background:#0a1931;color:#ffcc00;padding:10px 8px;text-align:left}.admin-table td{padding:8px;border-bottom:1px solid #eee}
